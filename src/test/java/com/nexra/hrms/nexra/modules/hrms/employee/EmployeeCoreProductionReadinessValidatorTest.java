...
import com.nexra.hrms.nexra.modules.hrms.employee.config.EmployeeCoreProductionReadinessValidator;
...
@DisplayName("EmployeeCoreProductionReadinessValidator")
class EmployeeCoreProductionReadinessValidatorTest {

    private Environment environment;
    private EmployeeCoreProperties properties;

    @BeforeEach
    void setUp() {
        environment = mock(Environment.class);
        properties = new EmployeeCoreProperties();
    ...
    void shouldSkipValidationForTestProfile() {
        ...
        EmployeeCoreProductionReadinessValidator validator = new EmployeeCoreProductionReadinessValidator(environment, properties);
