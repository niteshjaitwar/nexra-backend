...
import com.nexra.hrms.nexra.modules.hrms.leave.config.LeaveProductionReadinessValidator;
...
@DisplayName("LeaveProductionReadinessValidator")
class LeaveProductionReadinessValidatorTest {

    private Environment environment;
    private LeaveProperties properties;

    @BeforeEach
    void setUp() {
        environment = mock(Environment.class);
        properties = new LeaveProperties();
    ...
    void shouldSkipValidationForTestProfile() {
        ...
        LeaveProductionReadinessValidator validator = new LeaveProductionReadinessValidator(environment, properties);
