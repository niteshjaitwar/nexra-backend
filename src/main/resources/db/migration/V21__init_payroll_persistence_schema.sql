...
CREATE TABLE payroll_slips (
    ...
    currency VARCHAR(10) NOT NULL,
    organization_profile_json CLOB NOT NULL,
    employee_profile_json CLOB,
    allowances_json CLOB NOT NULL,
    deductions_json CLOB NOT NULL,
    auth_dependency_status_json CLOB NOT NULL,
