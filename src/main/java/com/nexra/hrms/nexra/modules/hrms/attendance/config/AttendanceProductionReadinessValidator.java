...
/**
 * Fails fast when attendance production configuration is unsafe.
 *
...
public class AttendanceProductionReadinessValidator implements ApplicationRunner {
    ...
    public void run(final ApplicationArguments args) {
        ...
        String jwtSecret = attendanceProperties.getSecurity().getJwtSecret();
