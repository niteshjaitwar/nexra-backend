...
/**
 * Fails fast when recruitment production configuration is unsafe.
 *
...
public class RecruitmentProductionReadinessValidator implements ApplicationRunner {
    ...
    public void run(final ApplicationArguments args) {
        ...
        String jwtSecret = recruitmentProperties.getSecurity().getJwtSecret();
