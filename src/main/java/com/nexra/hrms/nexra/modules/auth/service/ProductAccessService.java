...
public interface ProductAccessService {
     ...
     */
    List<ProductAccessResponse> getProductAccess(UUID userId);
     ...
     */
    ProductAccessResponse grantAccess(UUID userId, GrantProductAccessRequest request, UUID grantedByUserId);
     ...
     */
    void revokeAccess(UUID userId, ProductType product);
}
