...
public interface EmployeeRepository extends JpaRepository<EmployeeEntity, String> {
    ...
    // Paginated queries
    Page<EmployeeEntity> findByTenantCodeIgnoreCase(String tenantCode, Pageable pageable);
    Page<EmployeeEntity> findByTenantCodeIgnoreCaseAndActiveTrue(String tenantCode, Pageable pageable);
    Page<EmployeeEntity> findByTenantCodeIgnoreCaseAndDepartmentId(String tenantCode, String departmentId, Pageable pageable);
    Page<EmployeeEntity> findByTenantCodeIgnoreCaseAndDepartmentIdAndActiveTrue(String tenantCode, String departmentId, Pageable pageable);
}
