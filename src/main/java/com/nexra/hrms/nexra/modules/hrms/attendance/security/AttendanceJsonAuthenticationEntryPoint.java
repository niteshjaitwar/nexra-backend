...
/**
 * Returns a standardized JSON response for unauthenticated attendance access.
 *
 * @author niteshjaitwar
 * @version 1.0
 */
@Component
public class AttendanceJsonAuthenticationEntryPoint implements AuthenticationEntryPoint {
