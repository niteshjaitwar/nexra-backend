...
/**
 * Propagates a stable request identifier through expense logs and responses.
 *
 * @author niteshjaitwar
 * @version 1.0
 */
@Component
public class ExpenseRequestCorrelationFilter extends OncePerRequestFilter {

    private static final String REQUEST_ID_HEADER = "X-Request-Id";
    private static final String MDC_KEY = "requestId";
    private static final String MODULE_PATH_PREFIX = "/api/v1/expense/";
