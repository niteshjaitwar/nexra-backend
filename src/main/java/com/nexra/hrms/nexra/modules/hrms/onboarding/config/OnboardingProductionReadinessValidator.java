...
/**
 * Fails fast when onboarding production configuration is unsafe.
 *
...
public class OnboardingProductionReadinessValidator implements ApplicationRunner {
    ...
    public void run(final ApplicationArguments args) {
        ...
        String jwtSecret = onboardingProperties.getSecurity().getJwtSecret();
