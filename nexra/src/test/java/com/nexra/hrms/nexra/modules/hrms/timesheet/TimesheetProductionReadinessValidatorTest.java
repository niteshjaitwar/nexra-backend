...
import com.nexra.hrms.nexra.modules.hrms.timesheet.config.TimesheetProductionReadinessValidator;
...
@DisplayName("TimesheetProductionReadinessValidator")
class TimesheetProductionReadinessValidatorTest {

    private Environment environment;
    private TimesheetProperties properties;

    @BeforeEach
    void setUp() {
        environment = mock(Environment.class);
        properties = new TimesheetProperties();
    ...
    void shouldSkipValidationForTestProfile() {
        ...
        TimesheetProductionReadinessValidator validator = new TimesheetProductionReadinessValidator(environment, properties);
