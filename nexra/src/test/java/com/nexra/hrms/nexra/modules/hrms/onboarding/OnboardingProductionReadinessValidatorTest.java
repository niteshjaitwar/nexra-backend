...
import com.nexra.hrms.nexra.modules.hrms.onboarding.config.OnboardingProductionReadinessValidator;
...
@DisplayName("OnboardingProductionReadinessValidator")
class OnboardingProductionReadinessValidatorTest {

    private Environment environment;
    private OnboardingProperties properties;

    @BeforeEach
    void setUp() {
        environment = mock(Environment.class);
        properties = new OnboardingProperties();
    ...
    void shouldSkipValidationForTestProfile() {
        ...
        OnboardingProductionReadinessValidator validator = new OnboardingProductionReadinessValidator(environment, properties);
