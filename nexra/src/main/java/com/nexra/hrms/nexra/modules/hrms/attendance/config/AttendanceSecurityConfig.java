...
import com.nexra.hrms.nexra.modules.hrms.attendance.security.AttendanceRequestCorrelationFilter;
...
public class AttendanceSecurityConfig {
    ...
    public SecurityFilterChain attendanceSecurityFilterChain(
        ...
        final AttendanceRequestCorrelationFilter requestCorrelationFilter,
