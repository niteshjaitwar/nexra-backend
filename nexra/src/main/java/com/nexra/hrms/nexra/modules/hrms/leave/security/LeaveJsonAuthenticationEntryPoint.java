...
/**
 * Returns a standardized JSON response for unauthenticated leave access.
 *
 * @author niteshjaitwar
 * @version 1.0
 */
@Component
public class LeaveJsonAuthenticationEntryPoint implements AuthenticationEntryPoint {
