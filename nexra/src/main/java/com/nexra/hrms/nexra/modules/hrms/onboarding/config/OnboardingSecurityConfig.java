...
import com.nexra.hrms.nexra.modules.hrms.onboarding.security.OnboardingRequestCorrelationFilter;
...
public class OnboardingSecurityConfig {
    ...
    public SecurityFilterChain onboardingSecurityFilterChain(
        ...
        final OnboardingRequestCorrelationFilter requestCorrelationFilter,
