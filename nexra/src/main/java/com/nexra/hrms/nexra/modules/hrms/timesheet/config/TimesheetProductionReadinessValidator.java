...
/**
 * Fails fast when timesheet production configuration is unsafe.
 *
...
public class TimesheetProductionReadinessValidator implements ApplicationRunner {
    ...
    public void run(final ApplicationArguments args) {
        ...
        String jwtSecret = timesheetProperties.getSecurity().getJwtSecret();
