...
/**
 * Fails fast when performance production configuration is unsafe.
 *
...
public class PerformanceProductionReadinessValidator implements ApplicationRunner {
    ...
    public void run(final ApplicationArguments args) {
        ...
        String jwtSecret = performanceProperties.getSecurity().getJwtSecret();
